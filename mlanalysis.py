...
class MLAnalysis(object):
    ...
    def runRF(self):
        ...
        if self.plot:
            ...
            self.plot_confusion_matrix(
                confusion, title="RF, {}, {:2f}".format(self.filename, params[0])
            )
    ...
    def createSVM(self, kernel, gamma, C):
        ...
        if kernel not in ["linear", "rbf", "poly"]:
            ...
            return None
        logging.debug(
            " Creating SVM model: {} kernel, {} gamma, {} C".format(kernel, gamma, C)
        )
    ...
    def createKNN(self, K, weight):
        ...
        """
        logging.debug(
            " Creating a KNN model: {} neighbors and {} weight".format(K, weight)
        )
    ...
    def createRF(self, n_estimators, max_features):
        ...
        """
        logging.debug(
            " Creating RF model: {} n_est, {} max_feat".format(
